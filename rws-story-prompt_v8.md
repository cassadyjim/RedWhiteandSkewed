...
1. **Wikimedia Commons** — `commons.wikimedia.org` — Search for CC0 or Public Domain images
2. **U.S. Government Photos** — Congress, federal agencies, military — all public domain by law
3. **Unsplash** — `unsplash.com` — Free for commercial use, no attribution required
4. **Pexels** — `pexels.com` — Free for commercial use
...
**Image JSON Format** (place immediately after `"date"`, before `"title"`):

```json
"image": {
  "url": "https://upload.wikimedia.org/wikipedia/commons/...",
  "credit": "Photo: Photographer Name / Source",
...
**To find a Wikimedia Commons image URL**, use the `rws_find_image.py` script:
```bash
