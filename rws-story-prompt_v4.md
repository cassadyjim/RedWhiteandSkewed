# Red White & Skewed Story Creation Prompt v4
...
The goal is to show how EACH SIDE'S MEDIA is framing the story—not balanced sources that present both sides. Seek quotes, headlines, and framing from outlets that lean heavily partisan.
...
- Search: "[topic] Hannity" or "[topic] Maddow"
...
**WHY THIS MATTERS:**
Balanced sources like AP, Reuters, or NPR won't show the partisan framing. We need to capture how each side's echo chamber is presenting the story to THEIR audience.
...
**GOOD:** "Fox News host Sean Hannity said on his show: '[specific cited quote with link]'"

**BAD:** "Liberals warned this could trigger catastrophe."
**GOOD:** "MSNBC's Rachel Maddow said: '[specific cited quote with link]'"

**BAD:** "One prominent liberal commentator wrote, 'We are watching democracy die in real time.'"
**GOOD:** "The New Republic's Michael Tomasky wrote: '[actual verified quote with link]'"

**BAD:** "Far-right voices called for [extreme position]."
**GOOD:** "Steve Bannon said on his War Room podcast: '[actual verified quote with link]'" OR [omit the paragraph if no quote found]

**BAD:** "Many conservatives celebrated the decision."
**GOOD:** "Breitbart's headline read: '[actual headline with link]' The article stated..."

**BAD:** "Progressive activists condemned the move."
**GOOD:** "Common Dreams reported that [activist name] said: '[actual quote with link]'"
...
5. After I choose, research deeply using PARTISAN SOURCES:
   - **Conservative searches:** "[topic] Fox News", "[topic] Newsmax", "[topic] Hannity", "[topic] Breitbart", "[topic] Washington Examiner"
   - **Liberal searches:** "[topic] MSNBC", "[topic] Rachel Maddow", "[topic] Daily Beast", "[topic] Salon", "[topic] HuffPost"
   - **Commentary searches:** "[topic] conservative reaction", "[topic] liberal reaction", "[topic] opinion"
6. **Before writing:** Compile a table of verified quotes with:
   - Speaker name
   - Exact quote
   - Source URL
   - Verification status (confirmed quote appears at that URL)
...
### Paywall Rule:
- If a source is behind a paywall and you cannot access the actual article content, DO NOT use that source
- Search results summaries are NOT verification - you must be able to access the actual page
- If you find a quote but can only link to a paywalled source, search for an accessible source that contains the same quote
- Acceptable accessible sources include: PBS, NPR, AP News, government websites (.gov), press releases, and most broadcast news sites
- If no accessible source exists for a quote, remove the quote entirely

## 11. POLL BUTTON CUSTOMIZATION
